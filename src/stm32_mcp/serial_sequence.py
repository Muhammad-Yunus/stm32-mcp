...
from .toolchain import get_temp_dir

_executor = ThreadPoolExecutor(max_workers=2)

CAPTURE_DIR = Path(get_temp_dir("captures"))
...
async def serial_sequence(
    ...
    Args:
        steps: JSON array of step objects. Step types:
            ...
            Captures are saved under the OS temp directory in stm32-mcp/captures/ as PNG files.
